...
| 3. Procurement, sales, finance, logistics | in progress | Purchase-order receiving and warehouse posting implemented                 |
...
that remains in the finance workflow. Official Vista document numbering remains
deliberately absent until `BUS-002` is approved. The remaining Phase 3 sales,
finance, reporting, and logistics workflows are still pending.
