...
| -------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | -------------------------------------------------------------------------- |
| BUS-001  | required | Legal business entities, branches, locations, addresses, warehouses, technician warehouses, registers, and operators                             | 4.1, 4.4, 5, 6.3, 8.1 | No production seed data; use immutable configurable entities               |
