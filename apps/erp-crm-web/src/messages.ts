export const messages = {
  ...
  procurement: {
    addRequirements: 'Add at least one supplier, product, and warehouse before creating an order.',
    addLine: 'Add another product',
    allStatuses: 'All statuses',
    allProductsAdded: 'All products added',
    ...
    currency: 'Currency',
    currencyHint: 'Three-letter code',
    delivered: 'Delivered',
    ...
    invoiced: 'Invoiced',
    line: 'Order line',
    orderCount: (count: number) => `${count} ${count === 1 ? 'order' : 'orders'}`,
    receiptCount: (count: number) => `${count} ${count === 1 ? 'receipt' : 'receipts'}`,
    productLineCount: (count: number) => `${count === 1 ? 'product line' : 'product lines'}`,
    orderRegister: 'Purchase order register',
    orderRegisterHint: 'Orders awaiting delivery and completed supplier purchases.',
    receiptRegister: 'Goods receipt register',
    receiptRegisterHint: 'Warehouse receipts created from confirmed supplier deliveries.',
    orderDetails: 'Order details',
    orderDetailsHint: 'Choose the supplier, receiving warehouse, and order currency.',
    orderFilters: 'Purchase order filters',
    orderLines: 'Order lines',
    orderProductHint: 'Add each product once with its quantity, price, and expected delivery date.',
    ...
    receiptDestination: 'Delivery destination',
    receiptProducts: 'Products in this delivery',
    receiptProductsHint:
      'Select only the products that arrived and enter the quantity received now.',
    selectedCount: (selected: number, total: number) => `${selected} of ${total} selected`,
    remainingToReceive: (quantity: string) => `${quantity} remaining to receive`,
    removeLine: 'Remove line',
    retry: 'Try again',
    save: 'Save order',
    saving: 'Saving order',
    serialNumbers: 'Serial numbers, one per line',
    serialNumbersPlaceholder: 'Enter one serial number per line',
    status: 'Status',
    supplier: 'Supplier',
    total: 'Order value',
    ...
    errors: {
      ...
      currencyCode: 'Enter a three-letter currency code such as BGN.',
      expectedDeliveryDate: 'Choose a valid expected delivery date.',
      productId: 'Choose an available product.',
      quantity: 'Enter a quantity greater than zero.',
      supplierPartnerId: 'Choose an active supplier.',
      unitPrice: 'Enter a valid unit price.',
      warehouseId: 'Choose an active receiving warehouse.',
    },
  },
  operations: {
    back: 'Back',
    backLabel: 'Back to system activity',
    allStatuses: 'All statuses',
    attempts: 'Attempts',
    cancel: 'Cancel',
    ...
    introduction: 'Review queued work, delivery progress, and items that need attention.',
  ...
  access: {
    ...
    authenticatorManualKey: 'Manual setup key',
    authenticatorUseLink: 'Use a setup link instead',
  ...
  partners: {
    ...
    registrationDetailsHint: 'Identity and tax information used across ERP and CRM records.',
    ...
    roles: 'Roles',
    save: 'Add partner',
    saveChanges: 'Save partner changes',
  ...
  categories: {
    ...
    expiryHint: 'Leave this clear when expiry dates do not apply to the category.',
    back: 'Back',
