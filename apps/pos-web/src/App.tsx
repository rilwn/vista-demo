...
function Application() {
  ...
  if (!session) {
    return <ApplicationLoading label="Preparing POS access" />;
  }
  ...
  return (
    <PosTerminal employeeName={session.context.displayName} onSignOut={authentication.logout} />
  );
}
  ...
  return (
    <div className="pos-terminal">
      <header className="pos-topbar">
        ...
        <Button className="pos-sign-out" onClick={() => void onSignOut()} variant="quiet">
          Sign out
        </Button>
      </header>
